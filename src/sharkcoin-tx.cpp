...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sharkcoin Core sharkcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sharkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sharkcoin transaction") + "\n" +
                               "  sharkcoin-tx [options] -create [commands]   " + _("Create hex-encoded sharkcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sharkcoin transaction
