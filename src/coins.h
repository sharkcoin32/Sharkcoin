...
/** 
    ...
    ****Note - for SKN we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of sharkcoin coming in to a transaction
