...
/* Sharkcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SKN"
#define QAPP_ORG_DOMAIN "sharkcoin.org"
#define QAPP_APP_NAME_DEFAULT "SKN-Qt"
#define QAPP_APP_NAME_TESTNET "SKN-Qt-testnet"
