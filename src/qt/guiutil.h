...
/** Utility functions used by the SKN Qt UI.
 */
namespace GUIUtil
{
...
// Render SKN addresses in monospace font
...
// Parse "sharkcoin:" URI into recipient object, return true on successful parsing
