...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Sharkcoin features */
        {"sharkcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sharkcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sharkcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sharkcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sharkcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sharkcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sharkcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sharkcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sharkcoin", "startmasternode", &startmasternode, true, true, false},
        {"sharkcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sharkcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sharkcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sharkcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sharkcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sharkcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sharkcoin", "preparebudget", &preparebudget, true, true, false},
        {"sharkcoin", "submitbudget", &submitbudget, true, true, false},
        {"sharkcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sharkcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sharkcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sharkcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sharkcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sharkcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sharkcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sharkcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"sharkcoin", "mnsync", &mnsync, true, true, false},
        {"sharkcoin", "spork", &spork, true, true, false},
        {"sharkcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> sharkcoin-cli " + methodname + " " + args + "\n";
}
