 ...
 * SKN system. There are three: the main network on which people trade goods
...
public:
    ...
    int SharkcoinBadBlockTime() const { return nSharkcoinBadBlockTime; }
    int SharkcoinBadBlocknBits() const { return nSharkcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nSharkcoinBadBlockTime;
    unsigned int nSharkcoinBadBlocknBits;
