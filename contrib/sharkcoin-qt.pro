...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/sharkcoin-cli.cpp \
           src/sharkcoin-tx.cpp \
           src/sharkcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/sharkcoin.qrc src/qt/sharkcoin_locale.qrc

TRANSLATIONS += src/qt/locale/sharkcoin_bg.ts \
                src/qt/locale/sharkcoin_de.ts \
                src/qt/locale/sharkcoin_en.ts \
                src/qt/locale/sharkcoin_es.ts \
                src/qt/locale/sharkcoin_fi.ts \
                src/qt/locale/sharkcoin_fr.ts \
                src/qt/locale/sharkcoin_it.ts \
                src/qt/locale/sharkcoin_ja.ts \
                src/qt/locale/sharkcoin_pl.ts \
                src/qt/locale/sharkcoin_pt.ts \
                src/qt/locale/sharkcoin_ru.ts \
                src/qt/locale/sharkcoin_sk.ts \
                src/qt/locale/sharkcoin_sv.ts \
                src/qt/locale/sharkcoin_vi.ts \
                src/qt/locale/sharkcoin_zh_CN.ts \
                src/qt/locale/sharkcoin_zh_TW.ts
