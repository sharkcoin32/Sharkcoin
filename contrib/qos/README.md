...
This means one can have an always-on sharkcoind instance running, and another local sharkcoind/sharkcoin-qt instance which connects to this node and receives blocks from it.
