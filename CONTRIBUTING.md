Contributing to SKN Core
============================

The SKN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/sharkcoin-project/sharkcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SKN Core project, and is not to be
confused with overall SKN Network Protocol consensus changes.

Whether a pull request is merged into SKN Core rests with the project merge
...
Patches that change SKN consensus rules are considerably more involved than
...
Where a patchset proposes to change the SKN consensus, it must have been
...
The project leader is the release manager for each SKN Core release.
